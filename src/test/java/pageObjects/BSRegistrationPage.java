...
public class BSRegistrationPage extends ConstructorPage {
	...
	public BSRegistrationPage(WebDriver driver)
	{
		super(driver);
	}
	...
	@FindBy (xpath="//button[@id='BSUSignupsubmit']")
